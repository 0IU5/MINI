    ...
    <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item my-2">
                    <a class="sidebar-link " href="{{ route('admin.carousel.index') }}" aria-expanded="false">
                        <span>
                ...
                {{-- <div class="">
                    <button id="settingMenuToggle"
                        ...
                        <div class="flex items-center">
                            <span
                                style="color: {{ request()->routeIs('admin.carousel.index') ? '#ffffff' : '' }};"
                                class="hove">
                        ...
                        <svg id="settingMenuChevron" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24"
                            style="fill: {{ request()->routeIs('admin.carousel.index') ? '#ffffff' : ' ' }}; 
                                    transition: transform 0.3s; 
                                    transform: {{ request()->routeIs('admin.carousel.index') ? 'rotate(180deg)' : 'rotate(0deg)' }};"
                            class="group-hover:fill-[#5D87FF]">
                            <path d="M16.293 9.293 12 13.586 7.707 9.293l-1.414 1.414L12 16.414l5.707-5.707z">
                            </path>
                        </svg>
                    ...
                    <div id="settingSubMenu"
                        class="{{ request()->routeIs('admin.carousel.index') ? '' : 'hidden' }} pl-4 space-y-2 mt-2">
